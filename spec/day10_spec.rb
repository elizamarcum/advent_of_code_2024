...
describe Day10 do
  ...
  describe Day10::Trailheads do
    ...
    describe "trails" do
      it 'returns every valid trail from the trailhead for example 1' do
        input =
          <<~STRING
            .....0.
            ..4321.
          ...
          STRING
        expected = [
          [[0, 5], [1, 5], [2, 5], [3, 5], [4, 5], [5, 5], [5, 4], [5, 3], [5, 2], [6, 2]],
      ...
      it 'returns the correct number of trails for the trailhead for example 2' do
        input =
          <<~STRING
            012345
            123456
